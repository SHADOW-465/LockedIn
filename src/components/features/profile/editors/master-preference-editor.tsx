...
export function MasterPreferenceEditor({ value, onSave, onClose }: Props) {
    const [text, setText] = useState(value)

    return (
        <div className="p-6 space-y-4">
            <div>
                <h2 className="text-lg font-bold text-white">Hard Constraints for the Master</h2>
                <p className="text-xs text-white/50 mt-1">
                    The AI Master NEVER violates these. E.g. &ldquo;No outdoor tasks. No involving others.&rdquo;
                </p>
            </div>
            <textarea
                value={text}
                ...
                rows={5}
                placeholder="Enter your hard constraints for the Master..."
