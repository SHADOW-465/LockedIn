...
export function SessionIntentEditor({ value, onSave, onClose }: Props) {
    const [text, setText] = useState(value)

    return (
        <div className="p-6 space-y-4">
            <div>
                <h2 className="text-lg font-bold text-white">Session Goals &amp; Intent</h2>
                <p className="text-xs text-white/50 mt-1">
                    What do you want to achieve in your training sessions? The Master uses this to tailor your experience.
                </p>
            </div>
            <textarea
                value={text}
                ...
                rows={5}
                placeholder="E.g. 'I want to build obedience and endurance over the next month...'"
